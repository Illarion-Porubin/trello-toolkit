    ...
    reducers: {
        ...
        sort(state, action) {
            ...
            if (droppableIdStart !== droppableIdEnd) {
                ...
                return void(listEnd.cards.splice(+droppableIndexEnd, 0, ...card))
            }
            ...
            if (droppableIdStart !== "all-lists") {
                ...
                return void({ ...state, [+droppableIdStart]: list })
            }
        ...
        addCard(state, action) {
            console.log(state, "state")
            console.log(action.payload.text, "action text")
            const newCard = {
...
export const { addList, addCard, sort, changeCardText } = listsSlice.actions
